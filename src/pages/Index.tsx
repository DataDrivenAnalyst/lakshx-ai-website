            ...
            {[
              ...
              <CarouselItem key={i}>
                <div className="text-center">
                  <a href="/consultation" className="inline-block font-medium hover:underline transition-all duration-200">
                    {text}
                  </a>
                </div>
              </CarouselItem>
      ...
      <main>
        ...
        <section className="container pt-16 md:pt-24 pb-16">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative hidden md:block">
              <div
                className="absolute inset-0 rounded-2xl bg-gradient-primary opacity-20 blur-3xl"
                aria-hidden
              />
              <figure className="relative z-10">
                <img
                  src={`${baseUrl}lovable-uploads/46aa0e06-2714-4162-a3b2-ad82bf5415c7.png`}
                  alt="Illustration"
                  loading="lazy"
                  decoding="async"
                  className="mx-auto w-full max-w-lg rounded-xl shadow-elegant"
        ...
        <section id="solutions" className="container py-16 md:py-20">
          <header className="mb-10">
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              Outcome-first solutions tailored to your workflows and tools. Not one-size-fits-all software.
            </p>
          </header>
            ...
            <Card className="hover-scale">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Workflow className="text-primary" /> Automations
                </CardTitle>
              </CardHeader>
        ...
        <section id="process" className="container py-16 md:py-20">
          <header className="mb-10">
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              A lean, collaborative cadence — ship value in weeks, not quarters.
            </p>
          </header>
          <div className="grid gap-6 md:grid-cols-4">
            {["Discover", "Design", "Build", "Iterate"].map((title, i) => (
              <Card key={title} className="hover-scale">
                <CardHeader>
                  <div className="w-9 h-9 rounded-full bg-secondary text-secondary-foreground grid place-items-center mb-2 font-semibold">
                    {i + 1}
                  </div>
                ...
                <CardContent className="text-sm text-muted-foreground">
                  {[
                    "Map goals, constraints and systems. Define KPIs.",
                    "Solution blueprint, data flows, and guardrails.",
                    "Implement, integrate, and observe performance.",
                    "Refine with real usage; expand where ROI is clear.",
                  ][i]}
                </CardContent>
              </Card>
            ))}
        ...
        <section id="industries" className="container py-16 md:py-20">
          <header className="mb-6">
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              We’ve worked across FMCG, garments and textiles, e-commerce, battery equipment, consumer durables and more.
            </p>
          </header>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 text-sm">
            {[
              ...
              <div key={industry} className="rounded-md border bg-card px-3 py-2 text-center text-foreground/80">
                {industry}
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div>
              <h2 className="font-display text-3xl md:text-4xl">
                Why Laksh<span className="text-[hsl(var(--accent))]">X</span>
              </h2>
        ...
        <section id="contact" className="container py-16 md:py-24">
          <div className="rounded-2xl p-8 md:p-12 bg-gradient-primary text-primary-foreground shadow-glow">
            ...
            <p className="mt-2 text-primary-foreground/90 max-w-prose">
              Share your goals and challenges; we’ll propose a pragmatic path in 48 hours.
            </p>
            <div className="mt-6 space-y-3">
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <a
                    href="https://www.linkedin.com/company/laksh-x/"
                    target="_blank"
