      ...
      <div className="container py-10 grid gap-8 md:grid-cols-2 items-center">
        <div>
          <a href="#" className="flex items-center gap-2.5">
            <img src="/lovable-uploads/1967b777-9d89-4121-90de-792d10b3bab5.png" alt="LakshX logomark, background removed" loading="lazy" decoding="async" className="h-6 w-6 md:h-7 md:w-7 object-contain" />
