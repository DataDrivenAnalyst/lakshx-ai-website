...
export default function SiteFooter() {
  ...
  return <footer className="mt-24 border-t">
      <div className="container py-10 grid gap-8 md:grid-cols-2 items-center">
        <div>
          <a href="#" className="flex items-center gap-2.5">
            <img src={`${baseUrl}lovable-uploads/1967b777-9d89-4121-90de-792d10b3bab5.png`} alt="LakshX logomark, background removed" loading="lazy" decoding="async" className="h-6 w-6 md:h-7 md:w-7 object-contain" />
          ...
          <p className="mt-3 text-sm text-muted-foreground max-w-prose">AI automations, agents, and analytics for small and medium business</p>
